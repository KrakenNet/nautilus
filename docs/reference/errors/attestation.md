...
`nautilus/core/broker.py:1796`. Revoking the primary would leave nothing to sign with. Call
...
**`ValueError`**, `nautilus/core/broker.py:1361-1364`. A chained sink signs every line, so it
