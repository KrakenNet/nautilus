...
(`nautilus/transport/fastapi_app.py:184-190`, one `log.warning` line.)
...
`nautilus/transport/fastapi_app.py:193-200`. The index and the pluralisation change with the
