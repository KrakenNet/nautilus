...
(`nautilus/transport/fastapi_app.py:1228-1233`). Inside a request, the broker's drift gate treats a
...
(`nautilus/transport/fastapi_app.py:1228-1233`); inside a request the drift gate skips the check
