...
**`RuntimeError`**, `nautilus/core/broker.py:1978-1981`.
...
**`RuntimeError`**, `nautilus/core/broker.py:4347-4350`. Same rule for shutdown: `await
...
**`RuntimeError`**, `nautilus/core/broker.py:2498-2503`. `{method}` is the method you called.
...
**`PolicyEngineError`**, `nautilus/core/broker.py:2279-2283`. The handoff could not be recorded.
...
classification, evaluates, and queries `denial_record` (`nautilus/core/broker.py:2262-2278`). Any
...
**`ValueError`**, `nautilus/transport/fastapi_app.py:512-516`. No interpolation. Both
...
**`NotImplementedError`**, `nautilus/adapters/base.py:396`. No interpolation. The default
...
(`nautilus/transport/fastapi_app.py:1269-1274`) — a permanent refusal, not a retryable one, which
