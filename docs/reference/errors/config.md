...
(`nautilus/core/broker.py:1618`) when the broker builds the adapter.
...
**`ConfigError`**, `nautilus/core/broker.py:1404-1408`. `analysis.mode: llm` needs a provider
...
**`ConfigError`**, `nautilus/core/broker.py:661-666`. `{known}` is the configured hierarchy;
...
Raised by `Broker._load_custom_adapters` (`nautilus/core/broker.py:375-420`). `{i}` is the index
